...
#define OLED_TYPE u8g2_Setup_sh1106_i2c_128x64_noname_f(&u8g2, U8G2_R0, u8x8_byte_hw_i2c, u8x8_gpio_and_delay_hw_i2c);
...
#define KEYPAD_ROW_PINS    {25, 33, 26, 27}
#define KEYPAD_COLUMN_PINS {4, 5, 18, 19}
